              ...
              <div class="grid_view" id="grid_view">
                ...
                <div class="user_pf_area xs_zomm">
                  ...
                  <div class="basic_info">
                    <h1 class="name mt-1">{{$value->First_Name}}</h1>
                    <p class="little_description my-1">{{$value->Job1_Title}} at {{$value->Job1_Company}}<b>, </b>{{$value->Age}}</p>
                      <div class="private_info mb-2">
